...
const TagsGrid: FC<TagsGridProps> = () => {
  ...
  return (
    <div className="overflow-auto h-[calc(100vh-149px)] grid grid-rows-[199px] grid-cols-5 gap-x-[24px] gap-y-[36px]">
      {isLoading
        ...
        : data?.data.map((tag) => (
            <Card
              ...
              post={
                <div
                  className={`relative w-[${postSize}px] h-[${postSize}px] bg-[rgba(255,255,255,.06)] rounded-[8px]`}
                >
